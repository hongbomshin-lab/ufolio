...
test("default connections cover thirteen active sources and three inactive ones", () => {
  ...
  assert.deepEqual([...keys].sort(), [
    "CONS_SCORE", "CONS_SURGERY", "EXT", "IMPLANT", "OM", "OMS", "OMS_STAGE", "ORTHO", "PATH", "PED_CHART", "PED_SCORE", "PERIO",
