...
test("only the six admin-facing sheets stay visible and the rest are hidden", () => {
  const setup = loadSystemSetup();
  assert.deepEqual(Array.from(setup.SYS_VISIBLE_SHEETS), ["대시보드", "비교결과", "지각자", "보철비교", "현황시트연결", "측정값설정"]);
