...
function case_defaultMappings_() {
  ...
  return [
    ...
    case_mapping_("OMS_STAGE_BIOPSY_TOTAL", "승인", "OMS_STAGE", "Biopsy report 완료", "NONEMPTY_AS_ONE(F)", "", "NONEMPTY_AS_ONE(F)", case_target_(oms, "Total Case", "Biopsy"), "승인수", "SUM", 60, "report 사인 완료 후 Total Case 승인과 비교"),
    case_mapping_("OMS_STAGE_I_D_TOTAL", "승인", "OMS_STAGE", "I&D report 완료", "NONEMPTY_AS_ONE(K)", "", "NONEMPTY_AS_ONE(K)", case_target_(oms, "Total Case", "I & D"), "승인수", "SUM", 60, "report 사인 완료 후 Total Case 승인과 비교"),
  ];
}
